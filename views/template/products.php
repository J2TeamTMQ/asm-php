...
<section id="product" class="py-3">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <img src="<?php echo $item['item_image'] ?? "../views/assets/products/1.png" ?>" alt="product" class="img-fluid">
                <div class="form-row pt-4 font-size-16 font-baloo">
                    ...
                    <div class="col">
                        ...
                        if (in_array($item['item_id'], $Cart->getCartId($product->getData('cart')) ?? [])){
                            ...
                            echo '<button type="submit" name="top_sale_submit" class="btn btn-warning font-size-16 form-control" style="color: #fff;">Add to Cart</button>';
                        }
                        ?>
                    </div>
                </div>
                ...
                <div class="size my-3">
                    ...
                    <div class="d-flex justify-content-between w-75">
                        <div class="font-rubik border p-2">
                            <button class="btn p-0 font-size-14">30 - 35</button>
                        </div>
                        <div class="font-rubik border p-2">
                            <button class="btn p-0 font-size-14">35 - 40</button>
                        </div>
                        <div class="font-rubik border p-2">
                            <button class="btn p-0 font-size-14">40 - 45</button>
                        </div>
                    </div>
                </div>
                <!-- !size -->
